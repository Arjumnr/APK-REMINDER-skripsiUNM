...
public class adapterMahasiswa extends RecyclerView.Adapter<adapterMahasiswa.holderJadwalMahasiswa> {
    ...
    public void onBindViewHolder(@NonNull holderJadwalMahasiswa holder, int position) {
        ...
        holder.tglPertemuan.setText(jadwal.getTglPertemuan());
        holder.waktuPertemuan.setText(jadwal.getWaktuPertemuan());
    ...
    public class holderJadwalMahasiswa extends RecyclerView.ViewHolder {
        ImageView imageView ;
        TextView namaDosen;
